      ...
      <div className="relative z-10">
        ...
        <div className="relative overflow-hidden">
          <div className="pointer-events-none absolute inset-0" aria-hidden="true">
            ...
            <div
              className="absolute w-[1400px] h-[1000px] -bottom-[40%] -left-[25%] rounded-full"
              style={{
            ...
            {/* Pink orb — top right */}
            <div
              className="absolute w-[1400px] h-[1000px] -top-[20%] -right-[30%] rounded-full"
              style={{
                background: 'radial-gradient(ellipse, rgba(236,72,153,0.30) 0%, transparent 65%)',
              }}
            />
          </div>
        ...
        <section className="relative overflow-hidden border-t border-muted bg-surface/60">
          <div className="pointer-events-none absolute inset-0" aria-hidden="true">
            <div
              className="absolute w-[1400px] h-[1000px] -top-[60%] -left-[25%] rounded-full"
              style={{
                background: 'radial-gradient(ellipse, rgba(79,70,229,0.22) 0%, transparent 65%)',
              }}
            />
        ...
        {/* ── Q&A CHAT SECTION ── */}
        <section className="relative overflow-hidden border-t border-muted px-6 py-10 md:py-24">
          <div className="pointer-events-none absolute inset-0" aria-hidden="true">
            <div
              className="absolute w-[1400px] h-[1000px] -top-[60%] -left-[25%] rounded-full"
              style={{
